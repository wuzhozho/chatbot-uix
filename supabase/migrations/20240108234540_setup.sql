...
DECLARE
  ...
  project_url TEXT := 'https://nqosspntpsgqtsxtmngu.supabase.co';
  ...
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5xb3NzcG50cHNncXRzeHRtbmd1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNDQ4OTk2NiwiZXhwIjoyMDMwMDY1OTY2fQ.KEWMyUjUhSt4qCsVAmI1QXPOP94SeMed_mjH0uPYIYU';
